...
from hiveforge.prompts.agents import (
    BEEKEEPER_SYSTEM,
    QUEEN_BEE_SYSTEM,
    WORKER_BEE_SYSTEM,
    get_prompt_from_config,
...
from hiveforge.prompts.task_decomposition import TASK_DECOMPOSITION_SYSTEM
from hiveforge.prompts.vlm import (
