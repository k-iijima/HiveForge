...
from colonyforge.core import generate_event_id
from colonyforge.llm.client import LLMClient, Message
from colonyforge.prompts import TASK_DECOMPOSITION_SYSTEM

if TYPE_CHECKING:
    from colonyforge.guard_bee.models import GuardBeeReport
    from colonyforge.guard_bee.verifier import GuardBeeVerifier

logger = logging.getLogger(__name__)


# TASK_DECOMPOSITION_SYSTEM is imported from colonyforge.prompts
