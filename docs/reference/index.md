...
Technical reference documentation auto-generated from source code.

## API Reference

- [REST API Reference](api.md) — All 47 REST API endpoints with request/response schemas

## Python Modules

The following modules are documented via mkdocstrings (auto-generated from docstrings):
